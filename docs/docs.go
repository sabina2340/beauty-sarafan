...
const docTemplate = `{
        ...
        "/admin/users/{id}/moderate": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Новая роль и статус",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/ads": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Тип service|cabinet|salon",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/categories": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Фильтр по аудитории: master|client",
                        "name": "audience",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "models.Category": {
            ...
            "properties": {
                "audience": {
                    "description": "master | client | both",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
